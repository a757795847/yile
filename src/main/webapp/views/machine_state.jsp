...
<header>
    ...
    <ul class="machineHeader">
        <li class=" borderLeft none" data-name="synthesize" data-session="${sessionScope.allowsAdd}">综合机</li>
        <li class="borderLeft none" data-name="drink" data-session="${sessionScope.allowsAdd}">饮料机</li>
        <li class="none" data-name="coffee" data-session="${sessionScope.allowsAdd}">咖啡机</li>
    </ul>
